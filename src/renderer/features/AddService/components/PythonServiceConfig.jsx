                    ...
                    <div className="flex gap-2">
                        ...
                        <div className="relative flex-1">
                            <input
                                ...
                                required
                                className="w-full px-3 py-2 bg-[#161B22] border border-[#30363D] rounded-md text-[#C9D1D9] text-sm placeholder-[#8B949E] focus:outline-none focus:ring-1 focus:ring-[#1F6FEB] focus:border-[#1F6FEB] transition-all duration-200"
                        ...
                        <div className="relative" ref={dropdownRef}>
                            <button
                                ...
                                className="h-full min-w-[120px] px-3 py-2 bg-[#161B22] border border-[#30363D] rounded-md text-[#C9D1D9] text-sm hover:bg-[#21262D] transition-all duration-200 flex items-center gap-2"
                            >
                                {selectedFramework === 'fastapi' && (
                                    <svg className="w-3.5 h-3.5 text-[#58A6FF]" viewBox="0 0 24 24" fill="currentColor">
                            ...
                            {dropdownOpen && (
                                <div className="absolute right-0 mt-1 w-44 bg-[#161B22] border border-[#30363D] rounded-md shadow-lg z-10 py-1">
                                    <button
                                        onClick={() => {
                                    ...
                                    <div className="space-y-1">
                                        ...
                                        <div className="relative">
                                            <input
                                                ...
                                                onChange={handleChange}
                                                required
                                                className="w-full px-2.5 py-1.5 text-sm bg-[#161B22] border border-[#30363D] rounded-md text-[#C9D1D9] focus:outline-none focus:ring-1 focus:ring-[#1F6FEB] focus:border-[#1F6FEB] transition-all duration-200"
                                            />
                                            {!formData.host.trim() && (
                                                <div className="absolute inset-y-0 right-0 pr-3 flex items-center pointer-events-none">
                                                    <span className="text-[#F85149] text-xs">Required</span>
                                ...
                                <label className="flex items-start cursor-pointer hover:bg-[#161B22] p-2 rounded-md transition-colors">
                                    <div className="relative flex items-center h-4">
                                        <input
                                            ...
                                            className="sr-only"
                                        />
                                        <div className={`w-8 h-4 bg-[#21262D] rounded-full transition-colors ${formData.cors ? 'bg-[#238636]' : ''}`}>
                                            <div className={`absolute w-3 h-3 rounded-full transition-transform transform bg-white ${formData.cors ? 'translate-x-4' : 'translate-x-1'}`} style={{ top: '2px' }}></div>
                                        </div>
                                    </div>
                                    <div className="ml-3">
                        ...
                        <div className="relative rounded-lg bg-gradient-to-r from-[#161B22] to-[#0D1117] p-[1px] h-full">
                            <div className="rounded-lg bg-[#0D1117] p-5 h-full flex flex-col">
                                <div className="flex items-center mb-3">
                                    ...
                                    <h3 className="text-[#C9D1D9] text-sm font-medium">Access Control</h3>
                                </div>
                                ...
                                <div className="space-y-1">
                                    ...
                                    <div className="flex gap-2">
                                        <input
                                            ...
                                            className="flex-1 px-2.5 py-1.5 text-sm bg-[#161B22] border border-[#30363D] rounded-md text-[#C9D1D9] placeholder-[#8B949E] focus:outline-none focus:ring-1 focus:ring-[#1F6FEB] focus:border-[#1F6FEB] transition-all duration-200"
                                            placeholder="192.168.1.1"
                                        />
                                        <button
                                            type="button"
                                            onClick={handleAddIp}
                                            className="px-3 py-1.5 text-sm bg-[#238636] hover:bg-[#2EA043] text-white rounded-md transition-colors duration-200"
                                        >
                                            Add
                                        </button>
                                    </div>
