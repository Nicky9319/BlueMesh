...
const ConsoleSidebar = ({ isOpen, onToggle }) => {
    ...
    // Extract services from Redux store - handle both array and object structures
    ...
    const getServiceStatus = (service) => {
        // Mock status based on service properties
                                ...
                                {services.length > 0 ? (
                                    services.map((service, index) => {
                                        ...
                                        return (
                                            <div
                                                key={index}
                                                onClick={() => setSelectedItem(`service-${index}`)}
                                            ...
                                            >
                                                <div className="flex items-center gap-2 min-w-0 flex-1">
                                                    <div className={`w-2 h-2 rounded-full ${serviceStatus.color} flex-shrink-0`}></div>
